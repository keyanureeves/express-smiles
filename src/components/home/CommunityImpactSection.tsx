        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="order-2 lg:order-1">
            <div className="bg-white p-8 rounded-2xl shadow-lg transform transition-all duration-300 hover:shadow-xl border border-gray-100">
              <div className="flex items-start mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">Serving The Community</h3>
                  <p className="text-gray-600">
                    Our team at Express Smiles Dental Suite has conducted numerous dental camps 
                    throughout Nairobi, bringing essential oral healthcare to 
                    communities and those with limited access to dental services.
                  </p>
                </div>
              </div>
          ...
          <div className="order-1 lg:order-2 bg-white p-8 rounded-2xl shadow-lg">
            ...
            <p className="text-gray-600 mb-6 text-lg">
              Express Smiles Dental Suite has been deeply committed to serving the Nairobi community for over a decade. 
              Our passion for bringing quality dental care to everyone, especially the underserved, 
              has resulted in initiatives that have touched thousands of lives across Nairobi.
            </p>
            ...
            <div className="flex justify-center">
              <Button 
                ...
                onClick={() => window.open("https://wa.me/254799909232?text=Hello%2C%20I%E2%80%99d%20like%20to%20join%20your%20next%20community%20dental%20camp.%20Please%20share%20details%20about%20upcoming%20events.%20Thank%20you!", "_blank")}
              >
