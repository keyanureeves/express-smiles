...
const CtaSection = () => {
  const handleBookAppointment = () => {
    window.open("https://wa.me/254799909232?text=Hello%2C%20I%E2%80%99d%20like%20to%20book%20an%20appointment%20at%20Express%20Smiles%20Dental%20Suite.%20Please%20let%20me%20know%20the%20available%20slots.%20Thank%20you!", "_blank");
  };

  const handleCallNow = () => {
    window.open("tel:+254799909232");
  };
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Mon-Sun: 8:00am-6:00pm</p>
                    </div>
                  </motion.div>
