      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center gap-2 mb-10">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-center max-w-3xl">
            World-Class Dental Care for International Patients
          </h3>
        ...
        <div className="max-w-3xl mx-auto mb-12 text-center">
          <p className="text-lg text-gray-700">
            Tailored dental solutions for patients visiting Kenya. Experience the perfect combination of international standards and personalized care.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <Card className="shadow-lg border-t-4 border-t-primary hover:shadow-xl transition-all duration-300">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600 mb-4">
                Optimized treatment schedules that maximize results during your visit, with pre-planning before your arrival.
              </p>
          ...
          <Card className="shadow-lg border-t-4 border-t-green-600 hover:shadow-xl transition-all duration-300">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600 mb-4">
                Receive dental care that meets global benchmarks with the comfort of quality healthcare.
              </p>
              <ul className="space-y-2">
                {[
          ...
          <Card className="shadow-lg border-t-4 border-t-blue-500 hover:shadow-xl transition-all duration-300">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600 mb-4">
                Comprehensive care packages for your entire family, coordinated in one location.
              </p>
              <ul className="space-y-2">
                {[
          ...
          <div className="md:flex">
            <div className="md:w-2/3 p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">
                Start Your Dental Journey Before Arriving in Kenya
              </h3>
            ...
            <div className="md:w-1/3 bg-primary flex flex-col justify-center items-center p-8 text-white">
              <h4 className="text-2xl font-bold mb-4 text-center">Special Services</h4>
        ...
        <div className="max-w-3xl mx-auto text-center mb-10">
          <h3 className="text-2xl font-bold mb-6">Ready to Plan Your Dental Care in Kenya?</h3>
          <p className="text-gray-700 mb-8">
            Our dedicated coordinator will guide you through the entire process, from initial consultation to treatment completion.
          </p>
        </div>
        
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button 
            onClick={() => window.open("https://wa.me/254799909232?text=Hello%2C%20I%E2%80%99m%20interested%20in%20dental%20consultation.%20Please%20help%20me%20schedule%20a%20virtual%20meeting.%20Thank%20you!", "_blank")}
          ...
          <Button 
            ...
            onClick={() => window.open("tel:+254799909232")}
          >
            Speak with Coordinator <Phone className="ml-1 h-4 w-4" />
          </Button>
        </div>
      </div>
    </section>
