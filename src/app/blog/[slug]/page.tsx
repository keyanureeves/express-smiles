...
import { Calendar, Clock, ArrowLeft, ChevronRight, Facebook, Twitter, Copy } from "lucide-react";
...
export default function BlogPostPage() {
  ...
  const handleWhatsAppClick = () => {
    window.open(
      "https://wa.me/254799909232?text=Hello%2C%20I%20read%20your%20article%20about%20" +
        encodeURIComponent(post?.title || "") +
        "%20and%20I'd%20like%20to%20book%20an%20appointment%20at%20Express%20Smiles%20Dental%20Suite.%20Please%20let%20me%20know%20the%20available%20slots.%20Thank%20you!",
      "_blank"
    );
  };
  ...
  const sharePost = (platform: string) => {
    ...
    const title = `${post.title} | Express Smiles Dental Suite`;
    ...
    <div className="min-h-screen bg-background pb-20 lg:pb-0">
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              <Avatar className="h-12 w-12">
                <AvatarImage src="/doctor-avatar.jpg" alt="Dr. Victor Kinara" />
                <AvatarFallback>AB</AvatarFallback>
              </Avatar>
              <div>
                <h3 className="font-medium text-gray-900">Dr. Victor Kinara</h3>
                <p className="text-sm text-gray-500">Express Smiles Dental Suite</p>
              </div>
            </div>
          ...
          <img
            src={post?.image}
            alt={`${post?.title} - Dental health guide from Express Smiles Dental Suite`}
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all">
                      <div className="h-40 overflow-hidden">
                        <img
                          ...
                          alt={`${relatedPost.title} - Related dental health article from Express Smiles Dental Suite`}
